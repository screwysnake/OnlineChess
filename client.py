    ...
    if not game.connected():
        ...
        if player == 0:
            ...
            for i in range(0, 8):
                ...
                win.blit(text, (70, 110 + i * 60))
                win.blit(text, (570, 110 + i * 60))
            for i, letter in enumerate("abcdefgh"):
                text = font.render(letter, True, (77, 25, 0))
                win.blit(text, (110 + i * 60, 65))
            ...
            for key in game.white_captured.keys():
                for _ in range(game.white_captured[key]):
                    cell_rect = (85 + index * 30, 585, 35, 35)
            ...
            if game.white_material < game.black_material:
                ...
                win.blit(text, (85 + index * 30 + 5, 35))
        else:
            for row in range(8):
                for col in range(8):
                    if (row + col) % 2 == 0:
